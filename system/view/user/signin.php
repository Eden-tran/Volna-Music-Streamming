        ...
        <div class="sign__content">
            ...
            <form action="" method="post" class="sign__form">
                ...
                <div class="sign__group sign__group--checkbox">
                    <input id="remember" name="remember" type="checkbox" name='remember' checked="checked">
                ...
                <span class="sign__text">Don't have an account? <a href="<?= url('user', 'signup') ?>">Sign
                        up!</a></span>

                <span class="sign__text"><a href="<?= url('user', 'forgotpw') ?>">Forgot password?</a></span>
            </form>
