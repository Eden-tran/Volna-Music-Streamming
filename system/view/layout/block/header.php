...
<header class="header">
    <div class="header__content">
        ...
        <form action="" method="GET" class="header__search">
            <input type="hidden" name='c' value='album' placeholder="Artist, track or podcast">
            <input type="hidden" name='a' value='search' placeholder="Artist, track or podcast">
            <input type="text" name='txtSearch' placeholder="Artist, track or podcast">
        ...
        <div class="header__actions">
            ...
            <!-- <div class="header__action header__action--cart">
                ...
                <div class="header__drop">
                    ...
                    <div class="header__product">
                        <img src="public/img/store/item4.jpg" alt="">
                    ...
                    <div class="header__product">
                        <img src="public/img/store/item3.jpg" alt="">
                    ...
                    <div class="header__product">
                        <img src="public/img/store/item2.jpg" alt="">
            ...
            <div class="header__action header__action--signin">
                <a class="header__action-btn" href="<?= url('user', 'signin') ?>">
                    <span>Sign in</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
        ...
        <? } else { ?>
        <div class="header__action header__action--signin">
            <a class="header__action-btn" href="<?= url('user', 'logout') ?>">
